            ...
            <div class="col-md-8">
                ...
                <div class="leave-comment mr0"><!--leave comment-->
                    ...
                    <form class="form-horizontal contact-form" role="form" method="post" action="/profile" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <input type="password" class="form-control" id="password" name="password" placeholder="Выбранный вами пароль">
                            </div>
                        </div>
                        ...
                        <button type="submit" class="btn send-btn">Обновить профиль</button>
